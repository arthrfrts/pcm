...
{% include image.html url="/images/posts/the-sims.jpg" alt="Imagem do jogo" title="The Sims" %}
...
{% include image.html url="/images/posts/halo.jpg" alt="Imagem do jogo" title="Halo: Combat Evolved" %}
...
{% include image.html url="/images/posts/metroid-prime.jpg" alt="Imagem do jogo" title="Metroid Prime" %}
...
{% include image.html url="/images/posts/half-life-2.jpg" alt="Imagem do jogo" title="Half-Life 2" %}
...
{% include image.html url="/images/posts/shadow-of-the-colossus.jpg" alt="Imagem do jogo" title="Shadow of the Colossus" %}
...
{% include image.html url="/images/posts/call-of-duty-4-modern-warfare.jpg" alt="Imagem do jogo" title="Call of Duty 4: Modern Warfare" %}
...
{% include image.html url="/images/posts/super-smash-bros-brawl.jpg" alt="Imagem do jogo" title="Super Smash Bros. Brawl" %}
...
{% include image.html url="/images/posts/metal-gear-solid-4-guns-of-the-patriots.jpg" alt="Imagem do jogo" title="Metal Gear Solid 4: Guns of the Patriots" %}
...
{% include image.html url="/images/posts/super-mario-galaxy-2.png" alt="Imagem do jogo" title="Super Mario Galaxy 2" %}
...
{% include image.html url="/images/posts/portal-2.jpg" alt="Imagem do jogo" title="Portal 2" %}
...
{% include image.html url="/images/posts/skyrim.jpg" alt="Imagem do jogo" title="The Elder Scrolls V: Skyrim" %}
...
{% include image.html url="/images/posts/the-legend-of-zelda-skyward-sword.png" alt="Imagem do jogo" title="The Legend of Zelda: Skyward Sword" %}
...
{% include image.html url="/images/posts/journey.jpg" alt="Imagem do jogo" title="Journey" %}
...
{% include image.html url="/images/posts/the-last-of-us.jpg" alt="Imagem do jogo" title="The Last of Us" %}
...
{% include image.html url="/images/posts/grand-theft-auto-v.jpg" alt="Imagem do jogo" title="Grand Theft Auto V" %}
...
{% include image.html url="/images/posts/kentucky-route-zero.jpg" alt="Imagem do jogo" title="Kentucky Route Zero" %}
